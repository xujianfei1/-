...
const links = [
  { name: 'GitHub',         url: 'https://github.com',         icon: 'brand-github',  sortOrder: 1 },
  { name: 'ChatGPT',        url: 'https://chat.openai.com',    icon: 'brand-openai',     sortOrder: 2 },
  { name: 'Notion',         url: 'https://notion.so',          icon: 'brand-notion', sortOrder: 3 },
  { name: 'Stack Overflow', url: 'https://stackoverflow.com',  icon: 'brand-stackoverflow', sortOrder: 4 },
];
